...
export const sendVerificationEmail = async (user, res) => {
  ...
  const mailOptions = {
    ...
    html: `<div
    style = 'font-family: Times New Roman; font-size: 20px; color: #333; background-color: #f7f7f7; padding: 20px; border-radius: 5px;' >
    <h3 style="color: rgb(8, 56, 188)">Please verify your email address</h3>
    <hr>
    <h4>Hi ${lastName} जी,</h4>
    <p>
        Please verify your email address so we can know that it's really you.
        <br>
    <p> This link <b>expires in 1 घंटा🫣 </b></p >
    <br>
    <a href=${link}
